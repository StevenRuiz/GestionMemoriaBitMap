 ...
 * retorna la diferencia de tamaño entre las dos regiones a comparar
 * @verbatim
   ...
   Región de memoria 2:
    ...
    comparando las dos regiones da una diferencia de 32 KB
    limite de la región 1 - limite de la región 2
    64 KB - 32 KB = 32 KB
 ...
 * retorna la diferencia entre el valor int y el tamaño de la región
 *
 * @verbatim
   ...
   b = 1256 = 100111010000
   Región de memoria 1:
         base = 989 B = 1111011101
         limit = 64 KB

   b - base de la región de memoria
   100111010000 - 1111011101 = 10001011
 ...
 *
 * @verbatim
    Ejemplo: se va a liberar la región 1
    Heap X
        0           1           2           3           4
     -------     -------     -------     -------     -------
     |     |     |     |     |     |     |     |     |     |
     ...
     |Libre|     |Usado|     |Usado|     |Libre|     |Usado|
     -------     -------     -------     -------     -------
     se marca como región libre y se verifica si se puede fusionar con otra
     región libre que este inmediatamente a la izquierda o derecha
     En este caso se puede fusionar con la región que se encuentra a la
     iquierda.
 ...
 *
 * @verbatim
   La región de memoria debe estar ubicada dentro del área de datos
   Ejemplo:
